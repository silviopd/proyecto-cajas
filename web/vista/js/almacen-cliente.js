...
function listar() {
    ...
    var ruta = DIRECCION_WS + "cliente.almacen.listar.php";
...
$("#frmgrabar").submit(function(evento) {
    ...
    if ($("#txttipooperacion").val() == "agregar") {
        ...
        var ruta = DIRECCION_WS + "cliente.almacen.agregar.php";
        ...
        var ruta = DIRECCION_WS + "cliente.almacen.editar.php";
...
function leerDatos(id_cliente) {
    ...
    var ruta = DIRECCION_WS + "cliente.almacen.leerdatos.php";
