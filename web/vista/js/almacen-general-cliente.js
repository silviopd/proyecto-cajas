...
function listar() {
    ...
    var ruta = DIRECCION_WS + "cliente.almacen.general.listar.php";
...
$("#frmgrabar").submit(function(evento) {
    ...
    if ($("#txttipooperacion").val() == "agregar") {
        ...
        var ruta = DIRECCION_WS + "cliente.almacen.general.agregar.php";
        ...
        var ruta = DIRECCION_WS + "cliente.almacen.general.editar.php";
...
function leerDatos(id_cliente) {
    ...
    var ruta = DIRECCION_WS + "cliente.almacen.general.leerdatos.php";
