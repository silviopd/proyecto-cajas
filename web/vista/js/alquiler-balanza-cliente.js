...
function listar() {
    ...
    var ruta = DIRECCION_WS + "cliente.alquiler.balanza.listar.php";
...
$("#frmgrabar").submit(function(evento) {
    ...
    if ($("#txttipooperacion").val() == "agregar") {
        ...
        var ruta = DIRECCION_WS + "cliente.alquiler.balanza.agregar.php";
        var id_cliente = $("#modal_dni").val()
        ...
        var ruta = DIRECCION_WS + "cliente.alquiler.balanza.editar.php";
        var id_cliente = $("#modal_dni").val()
        var nombre = $("#modal_nombre").val()
        var estado = $("#modal_estado").val()
...
function leerDatos(id_cliente) {
    ...
    var ruta = DIRECCION_WS + "cliente.alquiler.balanza.leerdatos.php";
