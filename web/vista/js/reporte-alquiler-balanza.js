...
$("#btnfiltro_descargas").click(function(event) {
    ...
    var ruta = DIRECCION_WS + "../reportes/reporte.alquiler.balanza.php";

    $.post(ruta, function() {}).done(function() {

        window.open(DIRECCION_WS + "../reportes/alquiler-balanza.pdf")
...
function listar() {
    ...
    var ruta = DIRECCION_WS + "reporte.alquiler.balanza.listar.php";
