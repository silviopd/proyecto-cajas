...
$("#btnfiltro_descargas").click(function(event) {
    ...
    var ruta = DIRECCION_WS + "../reportes/reporte.ingreso.puerta4.php";

    $.post(ruta, function() {}).done(function() {

        window.open(DIRECCION_WS + "../reportes/ingreso-puerta4.pdf")
...
function listar() {
    ...
    var ruta = DIRECCION_WS + "reporte.ingreso.listar.php";
