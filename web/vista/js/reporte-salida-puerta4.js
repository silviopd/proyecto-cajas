...
$("#btnfiltro_descargas").click(function(event) {
    ...
    var ruta = DIRECCION_WS + "../reportes/reporte.salida.puerta4.php";

    $.post(ruta, function() {}).done(function() {

        window.open(DIRECCION_WS + "../reportes/salida-puerta4.pdf")
...
function listar() {
    ...
    var ruta = DIRECCION_WS + "reporte.salida.listar.php";
    ...
    $.post(ruta, function() {}).done(function(resultado) {
        ...
        if (datosJSON.estado === 200) {
            ...
            html += '<h5> TOTAL: '+round(total,2)+'</h5>';
            html += '</div>';
