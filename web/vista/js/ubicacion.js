...
function listar() {
    ...
    var ruta = DIRECCION_WS + "ubicacion.listar.php";
...
$("#frmgrabar").submit(function(evento) {
    ...
    if ($("#txttipooperacion").val() == "agregar") {
        ...
        var ruta = DIRECCION_WS + "ubicacion.agregar.php";
        ...
        var ruta = DIRECCION_WS + "ubicacion.editar.php";
...
function leerDatos(id_producto) {
    ...
    var ruta = DIRECCION_WS + "ubicacion.leerdatos.php";
