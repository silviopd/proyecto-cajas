...
try {
    ...
    $resultado = $obj->listarReporteRegistroEcomphisaFechas($fecha_inicio, $fecha_final);
...
<html lang="es">
    <head>
        ...
        <title>REPORTE ALMACEN REGISTRO ALQUILER</title>
    </head>
    <body >
        <section>
            <header>
...
';
    ...
    file_put_contents('./reporte-alquiler.pdf', $pdf->output());
} catch (Exception $exc) {
